...
var HeaderFilterCellComp = (props) => {
  const { context, gridOptionsService } = (0, import_react15.useContext)(BeansContext);
  ...
  const reactiveCustomComponents = (0, import_react15.useMemo)(() => gridOptionsService.get("reactiveCustomComponents"), []);
...
var PopupEditorComp = (props) => {
  ...
  const { context, popupService, localeService, gridOptionsService } = (0, import_react20.useContext)(BeansContext);
  useEffectOnce(() => {
...
var RowComp = (params) => {
  const { context, gridOptionsService } = (0, import_react18.useContext)(BeansContext);
...
var DetailCellRenderer = (0, import_react2.forwardRef)((props, ref) => {
  const { ctrlsFactory, context, gridOptionsService, resizeObserverService, clientSideRowModel, serverSideRowModel } = (0, import_react2.useContext)(BeansContext);
